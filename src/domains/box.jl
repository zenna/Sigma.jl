...
logmeasure(b::Box) = sum(map(log,[b.intervals[2,i] - b.intervals[1,i] for i = 1:ndims(b)]))
...
rand(b::Box) = [apply(rand_interval,b.intervals[:,i]) for i = 1:ndims(b)]
