...
"All kinds of Omega"
Omega{T} = Union{Vector{T},HyperBox{T}, LazyBox{T}, LazyRandomVector{T}, Dict{Int,T}}

"Abstract representations of sample space - euclidean box"
AbstractOmega{T} = Union{HyperBox{T}, LazyBox{T}}

"A concrete (i.e. not abstract) element ω in sample space Ω"
ConcreteOmega{T} = Union{Vector{T}, LazyRandomVector{T}}
